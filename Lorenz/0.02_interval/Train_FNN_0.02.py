...
step = 1
total = 5000
xyz1 = np.loadtxt('0.0_0.5_0.0_xyz')[::2,:]
...
xyz2 = np.loadtxt('1.0_1.0_1.0_xyz')[::2,:]
...
xyz3 = np.loadtxt('2.0_2.0_2.0_xyz')[::2,:]
...
xyzV = np.loadtxt('0.0_1.5_1.5_xyz')[::2,:]
...
model = torch.load("model_FNN1_0.02")
...
# _,_ = train(4001)
# torch.save(model, "model_FNN2_0.02")
