...
force1 = np.loadtxt('0.0_0.0_input_20%').reshape(1,300,1)
state1 = np.loadtxt('0.0_0.0_state_20%').reshape(1,301,2)
input1 = np.concatenate((state1[:,:-1,:],force1),axis = 2)

# print(input1.shape)

force2 = np.loadtxt('0.0_-1.0_input_20%').reshape(1,300,1)
state2 = np.loadtxt('0.0_-1.0_state_20%').reshape(1,301,2)
input2 = np.concatenate((state2[:,:-1,:],force2),axis = 2)
#
force3 = np.loadtxt('1.0_1.0_input_20%').reshape(1,300,1)
state3 = np.loadtxt('1.0_1.0_state_20%').reshape(1,301,2)
input3 = np.concatenate((state3[:,:-1,:],force3),axis = 2)
#
force4 = np.loadtxt('2.0_1.5_input_20%').reshape(1,300,1)
state4 = np.loadtxt('2.0_1.5_state_20%').reshape(1,301,2)
...
#
forceV = np.loadtxt('0.0_1.0_input_20%').reshape(1, 300, 1)
stateV = np.loadtxt('0.0_1.0_state_20%').reshape(1, 301, 2)
...
def train(epochs):
    ...
    for epoch in range(epochs):
        ...
        torch.save(GRU_model, "model1")

    return train_loss

# trainLoss = train(601)

# torch.save(GRU_model, "GRU_32_model_20%")
# torch.save(GRU_model, "LSTM_32_model_20%")
...
test_force = np.loadtxt(testName+'input_20%').reshape(1, 300, 1)
test_state = np.loadtxt(testName+'state_20%').reshape(1, 301, 2)
