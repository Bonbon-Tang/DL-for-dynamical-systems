...
forceV = np.loadtxt('1.0_0.0_input').reshape(300,1,1)
stateV = np.loadtxt('1.0_0.0_state').reshape(301,1,2)
...
# trainLoss = train(801)
torch.save(Transformer, "Transformer_withoutPE_10Pre_0%")
...
x_real = stateT[100:150,:,0].reshape(50)
v_real = stateT[100:150,:,1].reshape(50)
