...
forceV = np.loadtxt(testName+'input').reshape(1, 300, 1)
stateV = np.loadtxt(testName+'state').reshape(1, 301, 2)
...
# trainLoss = train(201)
# torch.save(GRU_model, "GRU_32_7%_model")
torch.save(GRU_model, "LSTM_32_7%_model")
