...
class TransformerModel(nn.Module):
    def __init__(self, intoken, outtoken,final, hidden, nlayers=3, dropout=0.1,steps = 5):
...
Transformer = TransformerModel(intoken=3, outtoken=3, final=2, hidden=20, nlayers=2, dropout=0.0,steps=4)
...
# trainLoss = train(601)
# torch.save(Transformer, "Transformer_withoutPE_5Pre_10%")
