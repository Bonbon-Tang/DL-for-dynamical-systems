...
#
forceV = np.loadtxt('1.0_0.0_input_2%').reshape(300,1)
stateV = np.loadtxt('1.0_0.0_state_2%').reshape(301,2)
...
torch.save(model, "model_3step_2%")

# testName = '2.0_1.0_'
# testName = '0.5_0.5_'
testName = '0.0_1.5_'

test_input = torch.Tensor(np.loadtxt(testName+'state_2%')[:100,:].reshape(100,2))
test_force = torch.Tensor(np.loadtxt(testName+'input_2%')[:150].reshape(150,1))
