...
step = 3
force1 = np.loadtxt('0.0_0.0_input_20%').reshape(300,1)
state1 = np.loadtxt('0.0_0.0_state_20%').reshape(301,2)
...
force2 = np.loadtxt('0.0_-1.0_input_20%').reshape(300,1)
state2 = np.loadtxt('0.0_-1.0_state_20%').reshape(301,2)
...
force3 = np.loadtxt('1.0_1.0_input_20%').reshape(300,1)
state3 = np.loadtxt('1.0_1.0_state_20%').reshape(301,2)
...
force4 = np.loadtxt('2.0_1.5_input_20%').reshape(300,1)
state4 = np.loadtxt('2.0_1.5_state_20%').reshape(301,2)
...
#
forceV = np.loadtxt('0.0_1.0_input_20%').reshape(300,1)
stateV = np.loadtxt('0.0_1.0_state_20%').reshape(301,2)
...
# torch.save(model, "model_3step_20%")

testName = '2.0_1.0_'
# testName = '0.5_0.5_'
# testName = '0.0_1.5_'

test_input = torch.Tensor(np.loadtxt(testName+'state_20%')[:100,:].reshape(100,2))
test_force = torch.Tensor(np.loadtxt(testName+'input_20%')[:150].reshape(150,1))
