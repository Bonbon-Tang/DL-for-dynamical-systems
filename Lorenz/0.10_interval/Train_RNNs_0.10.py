...
length = 200
total = 1000
xyz1 = np.loadtxt('0.0_0.5_0.0_xyz')[::10,:].reshape(total//length,length,3)
input1 = xyz1[:,:-1,:]
output1 = xyz1[:,1:,:]
# print(input1.shape,output1.shape)

xyz2 = np.loadtxt('1.0_1.0_1.0_xyz')[::10,:].reshape(total//length,length,3)
input2 = xyz2[:,:-1,:]
output2 = xyz2[:,1:,:]

xyz3 = np.loadtxt('2.0_2.0_2.0_xyz')[::10,:].reshape(total//length,length,3)
input3 = xyz3[:,:-1,:]
output3 = xyz3[:,1:,:]
...
xyzV = np.loadtxt('0.0_1.5_1.5_xyz')[::10,:].reshape(total//length,length,3)
inputV = xyzV[:,:-1,:]
outputV = xyzV[:,1:,:]
...
torch.save(RNN_model, "model_LSTM_0.10")
...
test_input = torch.Tensor(np.loadtxt('0.2_0.2_0.3_xyz'))[::10,:]
test_result = np.loadtxt('0.2_0.2_0.3_xyz')[::10,:]
...
test_result = np.loadtxt('0.2_0.2_0.3_xyz')[::10,:]
# test_result = np.loadtxt('0.2_0.2_0.3_xyz')[::10,:][test_length:,:]
