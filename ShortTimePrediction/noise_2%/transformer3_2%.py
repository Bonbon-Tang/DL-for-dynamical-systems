...
force1 = np.loadtxt('0.0_0.0_input_2%').reshape(300,1,1)
state1 = np.loadtxt('0.0_0.0_state_2%').reshape(301,1,2)
src1 = np.concatenate((state1[:-1,:,:],force1[:,:,:]),axis = 2)
output1 = state1[1:,:,:]

force2 = np.loadtxt('0.0_-1.0_input_2%').reshape(300,1,1)
state2 = np.loadtxt('0.0_-1.0_state_2%').reshape(301,1,2)
src2 = np.concatenate((state2[:-1,:,:],force2[:,:,:]),axis = 2)
output2 = state2[1:,:,:]

force3 = np.loadtxt('1.0_1.0_input_2%').reshape(300,1,1)
state3 = np.loadtxt('1.0_1.0_state_2%').reshape(301,1,2)
src3 = np.concatenate((state3[:-1,:,:],force3[:,:,:]),axis = 2)
output3 = state3[1:,:,:]

force4 = np.loadtxt('2.0_1.5_input_2%').reshape(300,1,1)
state4 = np.loadtxt('2.0_1.5_state_2%').reshape(301,1,2)
...
forceV = np.loadtxt('1.0_0.0_input_2%').reshape(300,1,1)
stateV = np.loadtxt('1.0_0.0_state_2%').reshape(301,1,2)
...
Transformer = TransformerModel(intoken=3, outtoken=3, final=2, hidden=20, nlayers=2, dropout=0.0,steps=10)
Transformer = torch.load("model2")
...
def train(epochs):
    ...
    for epoch in range(epochs):
        ...
        torch.save(Transformer, "model2")

    return train_loss

# trainLoss = train(801)
torch.save(Transformer, "Transformer_withoutPE_10Pre_2%")
...
forceT = np.loadtxt(testName+'input_2%').reshape(300,1,1)
stateT = np.loadtxt(testName+'state_2%').reshape(301,1,2)
