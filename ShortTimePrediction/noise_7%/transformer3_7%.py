...
force1 = np.loadtxt('0.0_0.0_input_7%').reshape(300,1,1)
state1 = np.loadtxt('0.0_0.0_state_7%').reshape(301,1,2)
src1 = np.concatenate((state1[:-1,:,:],force1[:,:,:]),axis = 2)
output1 = state1[1:,:,:]

force2 = np.loadtxt('0.0_-1.0_input_7%').reshape(300,1,1)
state2 = np.loadtxt('0.0_-1.0_state_7%').reshape(301,1,2)
src2 = np.concatenate((state2[:-1,:,:],force2[:,:,:]),axis = 2)
output2 = state2[1:,:,:]

force3 = np.loadtxt('1.0_1.0_input_7%').reshape(300,1,1)
state3 = np.loadtxt('1.0_1.0_state_7%').reshape(301,1,2)
src3 = np.concatenate((state3[:-1,:,:],force3[:,:,:]),axis = 2)
output3 = state3[1:,:,:]

force4 = np.loadtxt('2.0_1.5_input_7%').reshape(300,1,1)
state4 = np.loadtxt('2.0_1.5_state_7%').reshape(301,1,2)
...
forceV = np.loadtxt('1.0_0.0_input_7%').reshape(300,1,1)
stateV = np.loadtxt('1.0_0.0_state_7%').reshape(301,1,2)
...
# trainLoss = train(801)
torch.save(Transformer, "Transformer_withoutPE_10Pre_7%")
...
forceT = np.loadtxt(testName+'input_7%').reshape(300,1,1)
stateT = np.loadtxt(testName+'state_7%').reshape(301,1,2)
